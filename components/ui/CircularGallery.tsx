...
class App {
  ...
  constructor(
    container: HTMLElement,
    {
      ...
      textColor = "#002868",
      borderRadius = 0,
      // Use the local Momo font so canvas text matches .font-momo
      font = "normal 30px MomoTrustDisplay",
      scrollSpeed = 2,
      scrollEase = 0.05,
    }: AppConfig
  ) {
...
export default function CircularGallery({
  items,
  bend = 3,
  // default to site secondary color
  textColor = "#002868",
  borderRadius = 0.05,
  // default font to the project's MomoTrustDisplay so it matches .font-momo
  font = "normal 30px MomoTrustDisplay",
  scrollSpeed = 2,
  scrollEase = 0.05,
